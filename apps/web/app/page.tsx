...
import { SawaLiQShaderBackground } from '../components/SawaLiQShaderBackground'
import { SawaLiQCard } from '@sawaliq/ui'
import { UserService } from '@sawaliq/core'
import { loggers } from '@sawaliq/telemetry'
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
          ...
          >
            <div className="flex items-center space-x-8">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-bold text-lg gradient-text">SawaLiQ</span>
              </div>
        ...
        <section className="px-6 pb-12">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <SawaLiQCard variant="glass" interactive className="text-center">
            ...
            >
              <SawaLiQCard variant="elevated" className="inline-block">
                <div className="flex items-center space-x-8">
                  <div>
